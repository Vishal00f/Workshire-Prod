  ...
  return (
    <div className='m-5 p-4'>
       ...
       <div className="mb-4 flex justify-start">
        <button className={`px-3 py-3 ${view==="list"?"bg-gray-400":"bg-white"} rounded-l` } onClick={()=>setView("list")}>
          
          List
        </button>
        <button className={`px-3 py-3 ${view==="table"?"bg-gray-400":"bg-white"} rounded-l` } onClick={()=>setView("table")}>
          Table
        </button>
       </div>
