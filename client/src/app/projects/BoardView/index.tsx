...
const TaskColumn = ({
    ...
    return (
        <div ref={(instance)=>{drop(instance)}} className={`sm:py-4  rounded-lg py-2 xl:px-2 ${isOver?"bg-blue-100 dark:bg-neutral-950 ":""}`}>
            <div className='mb-3 flex w-full'>
                ...
                <div className='flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary'>
                    ...
                    <div className='flex items-center gap-1`'>
                        <button className='flex h-6 2-5 items-center justify-center dark:text-neutral-500'>
